     ...
     <li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
        ...
        <div id="comment-<?php comment_ID(); ?>" class="comment-body <?php echo $author_comment_class;?>">
            <div class="comment-author">
                <span class="author-name"><?php echo get_comment_author_link();?></span> <span class="comment-meta"><a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php printf(__('%1$s at %2$s'), get_comment_date(), get_comment_time()) ?></a><?php edit_comment_link(__('(Edit)'),' ','') ?>
